...
interface TransactionsRepository {
    ...
    suspend fun createTransaction(transactionDto: TransactionWriteDto): TransactionReadDto
    suspend fun updateTransaction(transactionId : Long, transactionDto: TransactionWriteDto): TransactionReadDto
}